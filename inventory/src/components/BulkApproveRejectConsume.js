...
export const BulkApproveRejectConsume = () => {
  ...
  const handleClick = async (e) => {
    ...
    e.preventDefault();
    try {
      const res = await fetch('http://localhost:8080/consumeditem/searchDateVerified', {
        method: 'post',
        headers: {
          'content-type': 'application/json',
          Authorization: `Bearer ${currentUser.accessToken}`,
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      const res = await fetch('http://localhost:8080/consumeditem/updateByDateVerifer', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${currentUser.accessToken}`,
...
export default BulkApproveRejectConsume;
